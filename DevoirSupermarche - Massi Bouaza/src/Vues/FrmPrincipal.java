...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       ...
       for(Employe eta : fm.GetAllEmployes())
        {
            cboEmployes.addItem(eta.getNomEmploye());
        }
...
//        fm = new FonctionsMetier();
//        dtmRayons = (DefaultTableModel)tblRayons.getModel();
//        dtmRayons.loadDatas(fm.GetAllRayonsByIdsecteur(Integer.parseInt(tblSecteurs.getValueAt(tblSecteurs.getSelectedRow(), 0).toString())));
//        tblRayons.setModel(dtmRayons);

        int numRayon = Integer.parseInt(tblSecteurs.getValueAt(tblSecteurs.getSelectedRow(), 0).toString());
        for(Rayon unRayon : fm.GetAllRayonsByIdsecteur(numRayon))
        {
            v = new Vector();
            v.add(unRayon.getIdRayon());
            v.add(unRayon.getNomRayon());
            dtmRayons.addRow(v);
        }
        tblRayons.setModel(dtmRayons);
    ...
    private void tblRayonsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRayonsMouseClicked
       ...
       for(Travailler unTravail : fm.GetAllTravailler(ERROR))
        {
            v = new Vector();
            v.add(unTravail.getUnEmploye());
            v.add(unTravail.getDateTravaillee());
            v.add(unTravail.getTempsPasse());
            dtmSecteurs.addRow(v);
        }
       tblEmployes.setModel(dtmEmployes);
       
       txtTotalHeuresRayon.setText(String.valueOf(fm.TotalHeuresRayon(ERROR)));
    ...
    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        ...
        {
            JOptionPane.showMessageDialog(this,"Sélectionner un employer","Erreur",JOptionPane.ERROR_MESSAGE);
        }
        else
        {
            
            int numEtat = fm.GetIdEmployeByNom(cboEmployes.getSelectedItem().toString());
            fm.ModifierTemps(Integer.parseInt(tblEmployes.getValueAt(tblEmployes.getSelectedRow(), 0).toString()),);
            dtmEmployes = new DefaultTableModel();
            dtmEmployes.loadDatas(fm.GetIdEmployeByNom(unEmploye.getIdUser()));
            tblEmployes.setModel(dtmEmployes);
        }
    ...
    private void btnInsererTempsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsererTempsMouseClicked
        ...
        {
            JOptionPane.showMessageDialog(this,"Saisir un temps","Erreur",JOptionPane.ERROR_MESSAGE);
        }else{
